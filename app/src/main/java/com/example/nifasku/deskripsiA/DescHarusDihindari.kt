...
//        Toast.makeText(applicationContext, "Rule Clicked", Toast.LENGTH_LONG).show()
    ...
    private fun setComponentListener() {
        val ruleData = arrayListOf(
            RuleContent("", resources.getString(R.string.harus_dihindari_pertama), null, "dihindar_1.png"),
            RuleContent("",resources.getString(R.string.harus_dihindari_kedua), null, "dihindar_2.png"),
            RuleContent("", resources.getString(R.string.harus_dihindari_ketiga), null, "dihindar_3.png"),
            RuleContent("", resources.getString(R.string.harus_dihindari_keempat), null, "dihindar_4.png")
        )
